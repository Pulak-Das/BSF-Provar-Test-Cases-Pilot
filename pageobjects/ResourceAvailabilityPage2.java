...
public class ResourceAvailabilityPage2 {
	...
	public static class Frame {
		...
		@TextType()
		@FindBy(xpath = "//div[. = '18' and @class='slds-text-heading_medium ng-binding']/following::tr[1]//td[position() = count(//td[. = '18']/preceding-sibling::td)+1]")
		public WebElement dateHover;
		@ButtonType()
		@FindBy(xpath = "//td[5]/div[2]/div[1]/button")
		public WebElement dateClick;
		@ButtonType()
		@FindBy(xpath = "//td[3]/div[2]/div[1]/button")
